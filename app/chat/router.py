...
def synthesize_stream_get(text: str, token: str, voice_id: str | None = None, format: str = "mp3"):
    """Endpoint GET para Safari/iOS — acepta token como query param para usar con <audio src>."""
